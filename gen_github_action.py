...
jobs_daily['runs-on'] = ['self-hosted', 'linux']
config_daily = {
...
open(config_path_test, "w").write("# This file is automatically generated by gen_github_action.py on %s\n"%(datetime.now())+yaml.dump(config_test, default_flow_style=False, sort_keys=False))
print("CI config generated to %s"%(config_path_test))
open(config_path_daily, "w").write("# This file is automatically generated by gen_github_action.py on %s\n"%(datetime.now())+yaml.dump(config_daily, default_flow_style=False, sort_keys=False))
