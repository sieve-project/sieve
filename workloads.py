...
workloads = {
    ...
    "cass-operator": {
        ...
        .cmd("kubectl patch CassandraDatacenter cassandra-datacenter --type merge -p=\'{\"spec\":{\"size\": 3}}\'")
        .wait_for_pod_status(
            "cluster1-cassandra-datacenter-default-sts-2", common.RUNNING, 150
        )
        .cmd("kubectl patch CassandraDatacenter cassandra-datacenter --type merge -p=\'{\"spec\":{\"size\": 2}}\'")
        .wait_for_pod_status(
            "cluster1-cassandra-datacenter-default-sts-2", common.TERMINATED, 150
        )
        .wait(50),
    },
    "zookeeper-operator": {
        ...
        .wait_for_pod_status("zookeeper-cluster-1", common.TERMINATED)
        .wait_for_pvc_status("data-zookeeper-cluster-1", common.TERMINATED)
        .cmd(
    ...
    "mongodb-operator": {
        ...
        .wait_for_pod_status("mongodb-cluster-rs0-arbiter-0", common.TERMINATED)
        .wait_for_pod_status("mongodb-cluster-rs0-4", common.RUNNING)
        .cmd(
