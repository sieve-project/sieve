...
For what you expect to see from each test result json file, we stored all the json files generated by Sieve after reproducing the 31 bugs in the folder `expected_sieve_test_results` so that you can compare and verify the bugs are correctly reproduced.
For more detailed information, please refer to https://github.com/sieve-project/sieve/blob/osdi-ae/reproducing_bugs.md.

Optionally, if you also want to reproduce the 8 indirect bugs, please refer to TODO.
